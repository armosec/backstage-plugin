...
import armoBackstageTheme from './Utils/armoBackstageTheme';
...
const customTheme: BackstageTheme = {
  ...
  overrides: {
    ...
    ...createCustomThemeOverrides(armoBackstageTheme),
  },
};
...
const routes = (
      <FlatRoutes>
        <Route path="/" element={<Navigate to="kubescape-plugin" />} />
        <Route path="/compliance" element={<KubescapePluginControlsPage />} />
        <Route
          path="/vulnerabilities"
          element={<KubescapePluginVulnerabilitiesPage />}
        />
        <Route
        ...
        <Route path="/kubescape-plugin" element={<KubescapePluginPage />} />
      </FlatRoutes>
  );
